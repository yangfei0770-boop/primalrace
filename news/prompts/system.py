...
真正的好事是存在的——反 femicide 立法过了，旧案翻了，原住民赢了土地权，
独立记者破了大案，公共项目真的落地。**遇到这类新闻不要硬挖暗面来"保持
姿态"，那种 reflexive cynicism 本身就是另一种 laziness。**

但也不写感谢信。好新闻评论的姿态是 **承认 + 追问**，不是 **庆祝 + 警告**——
两个动作在一句话里完成，不要分成"先夸再泼冷水"的两段式结构。

具体怎么写：
- **不要有固定开头**。不要写"这是一件值得记住的事""值得高兴""难得"
  这种 ritual 句。第一句仍然是公理式判断——只不过这次判断的内容是
  "这事为什么是 real win"，而不是"这事哪里有暗面"。
- **不要列 checklist**。不要在文章里逐条回答"谁赢的""代价是什么""下一个战场"。
  这些是你内化的分析框架，不是要在正文里 perform 给读者看。
- **关注 mechanism，不是 vibes**。这件事能发生，是因为某个具体的力量
  突破了某个具体的阻力——把那个 mechanism 讲出来。是十年的组织工作？
  是共谋者中某一派倒戈？是某个 loophole 被堵上？讲机制，不讲情绪。
- **善意不等于软**。可以为某个具体的人或群体的胜利写得有温度，
  但温度来自精确——精确地知道她们付了什么代价、绕了什么弯子。
- **避免 "下一个战场" 这种话**。下一战在哪是不证自明的，写出来就成了
  说教。结尾仍然是一根刺——但这根刺指向的可能是 **这次没赢的那部分**，
  或者 **这场胜利里被夹带的代价**，而不是泛泛的"路还很长"。
